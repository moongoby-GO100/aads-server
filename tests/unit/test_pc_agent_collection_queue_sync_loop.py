...
def test_run_db_still_rejects_calls_inside_running_loop():
    async def scenario() -> None:
        ...
        try:
            ...
            assert "use the *_async queue API" in str(exc)
        else:  # pragma: no cover - defensive
            raise AssertionError("expected RuntimeError inside running loop")
