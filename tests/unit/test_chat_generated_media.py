    ...
    events = [
        {
            ...
            "content": '{"url":"/api/v1/image/gallery/media-abc123/image","job_id":"media-abc123","status":"succeeded"}',
        }
    ]
...
def test_legacy_static_generated_url_is_normalized_and_not_duplicated():
    legacy = "/static/media/generated/image/media-old123.png"
    public_url = "/api/v1/image/gallery/media-old123/image"

    assert _normalize_generated_image_url(legacy) == public_url
    ...
    events = [
        {
            ...
            "tool_name": "generate_image",
            "is_error": True,
            "content": '{"url":"/api/v1/image/gallery/media-failed/image","status":"failed"}',
        }
    ]
