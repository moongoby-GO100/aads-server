...
- Dashboard release `979e127d9cef` is on both slots and shows the live relay denominator, pending target, and transition state.
...
- Dashboard Blue/Green images match release `979e127d9cef`.
