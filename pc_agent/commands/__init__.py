...
_RAW_HANDLERS = {
    ...
    "browser_press_key": _handler(browser_auto, "browser_press_key"),
    "browser_select_option": _handler(browser_auto, "browser_select_option"),
    "browser_check": _handler(browser_auto, "browser_check"),
    "browser_file_upload": _handler(browser_auto, "browser_file_upload"),
    "browser_download": _handler(browser_auto, "browser_download"),
