"""Build the AADS Finance Collector Windows setup executable.

Unified builder for Shinhan + IBK bank transaction collection.

Run this on Windows:
    python build_finance_collector_exe.py

Output:
    pc_agent/dist/AADS-Finance-Collector-Setup.exe
"""
...
ENTRYPOINT = SCRIPT_DIR / "finance_collector_launcher.py"
DIST_DIR = SCRIPT_DIR / "dist"
BUILD_DIR = SCRIPT_DIR / "build_tmp" / "finance_collector"
SPEC_DIR = SCRIPT_DIR / "build_tmp"
ICON_FILE = SCRIPT_DIR / "icon.ico"
EXE_NAME = "AADS-Finance-Collector-Setup"
