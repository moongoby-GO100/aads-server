-- AADS-LOGIN-COLLECTOR-SAAS-MVP: tenant-isolated authenticated site collection.
-- Additive migration. Credentials, cookies and challenge answers are intentionally excluded.
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE browser_recipes ADD CONSTRAINT browser_recipes_site_environment_check
            CHECK (site_environment IN ('webview2','chrome_extension','chrome_cdp','playwright_server','file_upload','official_api','manual_export'));
    END IF;
