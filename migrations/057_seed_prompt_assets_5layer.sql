-- 057: Seed prompt_assets for 5-layer prompt architecture
-- L1=Global, L2=Project, L3=Role, L4=Intent, L5=AI Model
-- Created: 2026-04-27

-- L1: Global (applies to all workspaces/intents/models/roles)
...
VALUES ('global-core-directives', '글로벌 핵심 지시', 1,
...
INSERT INTO prompt_assets (slug, title, layer_id, content, workspace_scope, intent_scope, target_models, role_scope, priority, enabled, created_by)
VALUES ('global-response-quality', '글로벌 응답 품질', 1,
