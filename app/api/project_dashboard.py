...
async def get_analytics():
    ...
    try:
        ...
        # daily_trend — 지시서 파일 created_at 기반 (최근 7일)
        ...
        for i in range(6, -1, -1):
            ...
            daily_trend.append({"date": day, "tasks": daily_count.get(day, 0), "cost_usd": 0.0})
        ...
        for proj in sorted(all_projs):
            ...
            by_project.append({
                ...
                "last_activity": "",
                "completed": dir_info.get("completed", 0),
                "error": dir_info.get("error", 0),
                "total": dir_info.get("total", 0),
            })
