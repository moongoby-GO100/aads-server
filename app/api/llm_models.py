...
async def _seed_media_models(conn) -> None:
    ...
    await conn.execute("""
        ...
        VALUES
          ...
          ('kling','kling-v2','Kling v2','kling','media_multimodal','kling-v2',true,'manual'),
          ('kling','kling-v2-1','Kling v2.1 Image','kling','media_image','kling-v2-1',true,'manual'),
          ('kling','kling-v2-new','Kling v2 New Image-to-Image','kling','media_image','kling-v2-new',true,'manual'),
          ...
          ('kling','kling-v3','Kling v3 Video','kling','media_video','kling-v3',true,'manual'),
    ...
    await conn.execute("""
        ...
        VALUES
          ...
          ('image','kling','kling-v2',70,true,false,'Kling v2 text-to-image','system'),
          ('image','kling','kling-v2-1',71,true,false,'Kling v2.1 text-to-image','system'),
          ('image','kling','kling-v2-new',72,true,false,'Kling v2 image-to-image','system'),
          ('video','runway','gen-4-turbo',10,true,false,'Gen-4 Turbo','system'),
          ('video','kling','kling-2.0',20,true,false,'Kling 2.0','system'),
          ('video','kling','kling-v2',21,true,false,'Kling v2 text/image-to-video','system'),
          ('video','kling','kling-v3',22,true,false,'Kling v3 text/image-to-video','system'),
